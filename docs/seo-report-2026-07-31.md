...
## 3차 점검 (2026-08-01 — 페이지 삭제·개편·카피 수정 반영 후)

| 페이지 | SEO | GEO | AEO |
|---|---|---|---|
| **핵심 7페이지** (index·vietnam-tiktok·tourist-vn/cn·local-vn·stay·help) | **100** | **100** | **100** |
| agency (재디자인 후) | 100 | 100 | 90 |
| blog 목록·inquiry | 100 | 100 | 40 |
| blog 글 4건 | 100 | 80~100 | 50 |
| **평균** | **100** | **96** | **76** |

이번에 정리한 것:
- 기술 SEO 재굽기 — 삭제 페이지 반영된 sitemap(14 URL), FAQ·엔티티 구조화데이터 최신화
- 평가기 오탐 수정: 홈(index)의 브레드크럼 감점 면제 (홈에 BreadcrumbList는 표준상 불필요)
- stay 메타 설명에 지역 키워드('한국 호텔·펜션') 자연 보강 → GEO 100

남은 감점 = 전부 의도된 것: 블로그 글·목록·문의 페이지에 FAQ를 억지로 넣지 않는 방침, 블로그 글의 H3 미사용(짧은 글이라 과함). 콘텐츠 성격상 만점 대상이 아님.
